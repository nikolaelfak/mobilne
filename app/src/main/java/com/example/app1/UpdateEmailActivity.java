...
public class UpdateEmailActivity extends AppCompatActivity {
        ...
        buttonVerifyUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userPwd)){
                    ...
                    editTextPwd.setError("Please your password for authentication");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == android.R.id.home){
            ...
            Intent intent = new Intent(UpdateEmailActivity.this, UploadActivity.class);
            startActivity(intent);
            finish();
        }else if(id == R.id.menu_recepts) {
            Intent intent = new Intent(UpdateEmailActivity.this, ReceptiActivity.class);
            startActivity(intent);
            finish();
        } else if(id == R.id.menu_map) {
            Intent intent = new Intent(UpdateEmailActivity.this, MapLocation.class);
            startActivity(intent);
            finish();
        }else if(id == R.id.rang_lista) {
            Intent intent = new Intent(UpdateEmailActivity.this, RangLista.class);
            startActivity(intent);
            finish();
            ...
            Toast.makeText(UpdateEmailActivity.this, "Something went worng!", Toast.LENGTH_LONG).show();
        }
