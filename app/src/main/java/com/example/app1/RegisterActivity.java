                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            try{
                                ...
                                editTextRegisterPwd.setError("Your email is invalid or alredy in use. Kindly re-enter");
                                editTextRegisterPwd.requestFocus();
                            } catch(FirebaseAuthUserCollisionException e) {
                                editTextRegisterPwd.setError("User is alredy registered with this email. Use another email");
                                editTextRegisterPwd.requestFocus();
                            } catch (Exception e) {
