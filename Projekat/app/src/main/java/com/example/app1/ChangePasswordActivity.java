...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getEditTextPwdConfirmNew = findViewById(R.id.editText_change_pwd_new_confirmed);
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(ChangePasswordActivity.this, "Password has been ferivied." + "Change password now", Toast.LENGTH_SHORT).show();
...
//            getEditTextPwdConfirmNew.setError("Please enter new password");
//            getEditTextPwdConfirmNew.requestFocus();
        } else {
            progressBar.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == android.R.id.home){
            ...
            Intent intent = new Intent(ChangePasswordActivity.this, UploadActivity.class);
            startActivity(intent);
            finish();
        } else if(id == R.id.menu_recepts) {
            Intent intent = new Intent(ChangePasswordActivity.this, ReceptiActivity.class);
            startActivity(intent);
            finish();
        } else if(id == R.id.menu_map) {
            Intent intent = new Intent(ChangePasswordActivity.this, MapLocation.class);
            startActivity(intent);
            finish();
        }else if(id == R.id.rang_lista) {
            Intent intent = new Intent(ChangePasswordActivity.this, RangLista.class);
            startActivity(intent);
            finish();
            ...
            Toast.makeText(ChangePasswordActivity.this, "Something went worng!", Toast.LENGTH_LONG).show();
        }
